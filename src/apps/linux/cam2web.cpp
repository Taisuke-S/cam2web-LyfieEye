...
const char* DEVICE_NAME = "Video for LyfieEye200 Camera";
...
{
    static const uint32_t SupportedWidth[]  = { 256, 368, 512, 736, 2976,2976,2976,2240,2240,2240, 1448,1448,1448,512,736,256,368 };
    static const uint32_t SupportedHeight[] = { 256, 368, 256, 368, 1392,1392,1392,1056,1056,1056, 1392,1392,1392,256,368,256,368 };
    ...
    if ( i != argc )
    {
        ...
        printf( "               0: 256x256@30 YUYV\n" );
        printf( "               1: 368x368@30 YUVU\n" );
        printf( "               2: 512x256@30 YUVU(default) \n" );
        printf( "               3: 736x368@30 YUVU\n" );
        printf( "               4: 2976x1392@24 MJPEG\n" );
        printf( "               5: 2976x1392@20 MJPEG\n" );
        printf( "               6: 2976x1392@10 MJPEG\n" );
        printf( "               7: 2240x1056@24 MJPEG\n" );
        printf( "               8: 2240x1056@20 MJPEG\n" );
        printf( "               0: 2240x1056@10 MJPEG\n" );
        printf( "               10: 1448x1392@24 MJPEG\n" );
        printf( "               11: 1448x1392@20 MJPEG\n" );
        printf( "               12: 1448x1392@10 MJPEG\n" );
        printf( "               13: 512x256@30 MJPEG\n" );
        printf( "               14: 736@368@30 MJPEG\n" );
        printf( "               15: 256@256@30 MJPEJ\n" );
        printf( "               16: 368@368@30 MJPEG\n" );
...
int main( int argc, char* argv[] )
{
    ...
    xcamera->EnableJpegEncoding( Settings.MJPEG ==1?true:false );
	...
	printf(" %d x %d @FPS%d %s\n",Settings.FrameWidth,Settings.FrameHeight,Settings.FrameRate,Settings.MJPEG==0?"YUVU":"MJPEG");
